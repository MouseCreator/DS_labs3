...
public class LocalController implements CommonController {
    private BufferedReader reader;
    private final PrintStream outputStream;
    public static LocalController consoleController() {
        return new LocalController(System.in, System.out);
    }
    public LocalController(InputStream in, PrintStream out) {
        setInputStream(in);
